...
TEST( align_enum_test, default_ctr )
{
...
TEST( align_enum_test, copy_assignment )
{
    align_enum algorithm{};
...
TEST( align_enum_test, move_assignment )
{
...
TEST( align_enum_test, constexpr_ctr )
{
    ...
    if constexpr(algorithm != align_enum::semi_global)
    {
        ...
        // or:
        ADD_FAILURE() << "expected algorithm == align_enum::semi_global"; // continues on error
        // FAIL() << "expected algorithm == align_enum::semi_global"; // throws on error
